...
exports.ExampleDataSource = exports.ContactsComponent = void 0;
...
var ContactsComponent = /** @class */ (function (_super) {
    tslib_1.__extends(ContactsComponent, _super);
    ...
    ContactsComponent.prototype.refresh = function () {
        this.loadData();
    };
    ContactsComponent.prototype.addNew = function () {
        var _this = this;
        var tempDirection;
        ...
        this.subs.sink = dialogRef.afterClosed().subscribe(function (result) {
            ...
            if (result === 1) {
                ...
                (_a = _this.exampleDatabase) === null || _a === void 0 ? void 0 : _a.dataChange.value.unshift(_this.contactsService.getDialogData());
                _this.refreshTable();
                _this.showNotification('snackbar-success', 'Add Record Successfully...!!!', 'bottom', 'center');
            }
        });
    };
    ContactsComponent.prototype.detailsCall = function (row) {
    ...
    ContactsComponent.prototype.toggleStar = function (row) {
        console.log(row);
    };
    ContactsComponent.prototype.editCall = function (row) {
        var _this = this;
        this.id = row.id;
        var tempDirection;
        if (localStorage.getItem('isRtl') === 'true') {
            ...
            if (result === 1) {
                ...
                if (foundIndex && _this.exampleDatabase) {
                    _this.exampleDatabase.dataChange.value[foundIndex] =
                        _this.contactsService.getDialogData();
    ...
    ContactsComponent.prototype.deleteItem = function (row) {
        var _this = this;
        this.id = row.id;
        var tempDirection;
        if (localStorage.getItem('isRtl') === 'true') {
    ...
    ContactsComponent.prototype.refreshTable = function () {
        this.paginator._changePageSize(this.paginator.pageSize);
    };
    /** Whether the number of selected elements matches the total number of rows. */
    ContactsComponent.prototype.isAllSelected = function () {
        var numSelected = this.selection.selected.length;
        var numRows = this.dataSource.renderedData.length;
        return numSelected === numRows;
    };
    /** Selects all rows if they are not all selected; otherwise clear selection. */
    ContactsComponent.prototype.masterToggle = function () {
        var _this = this;
        this.isAllSelected()
    ...
    ContactsComponent.prototype.removeSelectedRows = function () {
        var _this = this;
    ...
    ContactsComponent.prototype.loadData = function () {
        var _this = this;
        this.exampleDatabase = new contacts_service_1.ContactsService(this.httpClient);
    ...
    ContactsComponent.prototype.showNotification = function (colorName, text, placementFrom, placementAlign) {
    ...
    ], ContactsComponent.prototype, "paginator");
    tslib_1.__decorate([
        core_1.ViewChild(sort_1.MatSort, { static: true })
    ], ContactsComponent.prototype, "sort");
    tslib_1.__decorate([
        core_1.ViewChild('filter', { static: true })
    ], ContactsComponent.prototype, "filter");
    tslib_1.__decorate([
        core_1.ViewChild(menu_1.MatMenuTrigger)
    ], ContactsComponent.prototype, "contextMenu");
        ...
        return data.sort(function (a, b) {
            ...
            switch (_this._sort.active) {
                ...
                case 'email':
                    ...
                    break;
                case 'birthDate':
                    _d = tslib_1.__read([a.birthDate, b.birthDate], 2), propertyA = _d[0], propertyB = _d[1];
                    break;
                case 'address':
                    _e = tslib_1.__read([a.address, b.address], 2), propertyA = _e[0], propertyB = _e[1];
                    break;
            }
