...
exports.ExampleDataSource = exports.MyTasksComponent = void 0;
...
var my_tasks_service_1 = require("./my-tasks.service");
var tableExportUtil_1 = require("src/app/shared/tableExportUtil");
var common_1 = require("@angular/common");
var MyTasksComponent = /** @class */ (function (_super) {
    tslib_1.__extends(MyTasksComponent, _super);
    function MyTasksComponent(httpClient, dialog, myTasksService, snackBar) {
        var _this = _super.call(this) || this;
        _this.httpClient = httpClient;
        _this.dialog = dialog;
        _this.myTasksService = myTasksService;
    ...
    MyTasksComponent.prototype.refresh = function () {
        this.loadData();
    };
    MyTasksComponent.prototype.addNew = function () {
        var _this = this;
        var tempDirection;
        ...
        this.subs.sink = dialogRef.afterClosed().subscribe(function (result) {
            ...
            if (result === 1) {
                ...
                (_a = _this.exampleDatabase) === null || _a === void 0 ? void 0 : _a.dataChange.value.unshift(_this.myTasksService.getDialogData());
                _this.refreshTable();
                _this.showNotification('snackbar-success', 'Add Record Successfully...!!!', 'bottom', 'center');
            }
        });
    };
    MyTasksComponent.prototype.editCall = function (row) {
        var _this = this;
        this.id = row.id;
        var tempDirection;
        if (localStorage.getItem('isRtl') === 'true') {
            ...
            if (result === 1) {
                ...
                if (foundIndex && _this.exampleDatabase) {
                    _this.exampleDatabase.dataChange.value[foundIndex] =
                        _this.myTasksService.getDialogData();
    ...
    MyTasksComponent.prototype.deleteItem = function (i, row) {
        var _this = this;
        this.index = i;
        this.id = row.id;
        var tempDirection;
    ...
    MyTasksComponent.prototype.refreshTable = function () {
        this.paginator._changePageSize(this.paginator.pageSize);
    };
    /** Whether the number of selected elements matches the total number of rows. */
    MyTasksComponent.prototype.isAllSelected = function () {
        var numSelected = this.selection.selected.length;
        var numRows = this.dataSource.renderedData.length;
        return numSelected === numRows;
    };
    /** Selects all rows if they are not all selected; otherwise clear selection. */
    MyTasksComponent.prototype.masterToggle = function () {
        var _this = this;
        this.isAllSelected()
    ...
    MyTasksComponent.prototype.removeSelectedRows = function () {
        var _this = this;
    ...
    MyTasksComponent.prototype.loadData = function () {
        var _this = this;
        this.exampleDatabase = new my_tasks_service_1.MyTasksService(this.httpClient);
    ...
    MyTasksComponent.prototype.exportExcel = function () {
    ...
    MyTasksComponent.prototype.showNotification = function (colorName, text, placementFrom, placementAlign) {
    ...
    ], MyTasksComponent.prototype, "paginator");
    tslib_1.__decorate([
        core_1.ViewChild(sort_1.MatSort, { static: true })
    ], MyTasksComponent.prototype, "sort");
    tslib_1.__decorate([
        core_1.ViewChild('filter', { static: true })
    ], MyTasksComponent.prototype, "filter");
    MyTasksComponent = tslib_1.__decorate([
        core_1.Component({
    ...
    ExampleDataSource.prototype.connect = function () {
        ...
        return rxjs_1.merge.apply(void 0, tslib_1.__spreadArray([], tslib_1.__read(displayDataChanges))).pipe(operators_1.map(function () {
            ...
            _this.filteredData = _this.exampleDatabase.data
                .slice()
                .filter(function (myTasks) {
                var searchStr = (myTasks.taskNo +
                    myTasks.project +
                    myTasks.client +
                    myTasks.status +
                    myTasks.priority +
        ...
        return data.sort(function (a, b) {
            ...
            switch (_this._sort.active) {
                case 'id':
                    ...
                    break;
                case 'taskNo':
                    _b = tslib_1.__read([a.taskNo, b.taskNo], 2), propertyA = _b[0], propertyB = _b[1];
                    break;
                case 'project':
                    _c = tslib_1.__read([a.project, b.project], 2), propertyA = _c[0], propertyB = _c[1];
                    break;
                case 'client':
                    _d = tslib_1.__read([a.client, b.client], 2), propertyA = _d[0], propertyB = _d[1];
                    break;
                case 'status':
                    _e = tslib_1.__read([a.status, b.status], 2), propertyA = _e[0], propertyB = _e[1];
                    break;
                case 'priority':
                    _f = tslib_1.__read([a.priority, b.priority], 2), propertyA = _f[0], propertyB = _f[1];
                    break;
                case 'type':
                    _g = tslib_1.__read([a.type, b.type], 2), propertyA = _g[0], propertyB = _g[1];
                    break;
            }
