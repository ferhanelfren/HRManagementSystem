...
exports.ExampleDataSource = exports.LeadsComponent = void 0;
...
var LeadsComponent = /** @class */ (function (_super) {
    tslib_1.__extends(LeadsComponent, _super);
    function LeadsComponent(httpClient, dialog, leadsService, snackBar) {
    ...
    LeadsComponent.prototype.refresh = function () {
        this.loadData();
    };
    LeadsComponent.prototype.addNew = function () {
        var _this = this;
        var tempDirection;
        ...
        this.subs.sink = dialogRef.afterClosed().subscribe(function (result) {
            ...
            if (result === 1) {
                ...
                (_a = _this.exampleDatabase) === null || _a === void 0 ? void 0 : _a.dataChange.value.unshift(_this.leadsService.getDialogData());
                _this.refreshTable();
                _this.showNotification('snackbar-success', 'Add Record Successfully...!!!', 'bottom', 'center');
            }
        });
    };
    LeadsComponent.prototype.editCall = function (row) {
        var _this = this;
        this.id = row.id;
        var tempDirection;
        if (localStorage.getItem('isRtl') === 'true') {
            ...
            if (result === 1) {
                ...
                if (foundIndex && _this.exampleDatabase) {
                    _this.exampleDatabase.dataChange.value[foundIndex] =
                        _this.leadsService.getDialogData();
    ...
    LeadsComponent.prototype.deleteItem = function (i, row) {
        var _this = this;
        this.index = i;
        this.id = row.id;
        var tempDirection;
    ...
    LeadsComponent.prototype.refreshTable = function () {
        this.paginator._changePageSize(this.paginator.pageSize);
    };
    /** Whether the number of selected elements matches the total number of rows. */
    LeadsComponent.prototype.isAllSelected = function () {
        var numSelected = this.selection.selected.length;
        var numRows = this.dataSource.renderedData.length;
        return numSelected === numRows;
    };
    /** Selects all rows if they are not all selected; otherwise clear selection. */
    LeadsComponent.prototype.masterToggle = function () {
        var _this = this;
        this.isAllSelected()
    ...
    LeadsComponent.prototype.removeSelectedRows = function () {
        var _this = this;
    ...
    LeadsComponent.prototype.loadData = function () {
        var _this = this;
        this.exampleDatabase = new leads_service_1.LeadsService(this.httpClient);
    ...
    LeadsComponent.prototype.exportExcel = function () {
    ...
    LeadsComponent.prototype.showNotification = function (colorName, text, placementFrom, placementAlign) {
    ...
    // context menu
    LeadsComponent.prototype.onContextMenu = function (event, item) {
    ...
    ], LeadsComponent.prototype, "paginator");
    tslib_1.__decorate([
        core_1.ViewChild(sort_1.MatSort, { static: true })
    ], LeadsComponent.prototype, "sort");
    tslib_1.__decorate([
        core_1.ViewChild('filter', { static: true })
    ], LeadsComponent.prototype, "filter");
    tslib_1.__decorate([
        core_1.ViewChild(menu_1.MatMenuTrigger)
    ], LeadsComponent.prototype, "contextMenu");
    LeadsComponent = tslib_1.__decorate([
        core_1.Component({
            selector: 'app-leads',
    ...
    ExampleDataSource.prototype.connect = function () {
        ...
        return rxjs_1.merge.apply(void 0, tslib_1.__spreadArray([], tslib_1.__read(displayDataChanges))).pipe(operators_1.map(function () {
            ...
            _this.filteredData = _this.exampleDatabase.data
                ...
                var searchStr = (leads.name +
                    leads.department +
                    leads.role +
                    leads.project +
                    leads.email +
                    leads.mobile).toLowerCase();
        ...
        return data.sort(function (a, b) {
            ...
            switch (_this._sort.active) {
                ...
                case 'time':
                    ...
                    break;
                case 'mobile':
                    _e = tslib_1.__read([a.mobile, b.mobile], 2), propertyA = _e[0], propertyB = _e[1];
                    break;
            }
