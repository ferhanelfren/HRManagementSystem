...
exports.ExampleDataSource = exports.ResumesComponent = void 0;
...
var ResumesComponent = /** @class */ (function (_super) {
    tslib_1.__extends(ResumesComponent, _super);
    function ResumesComponent(httpClient, dialog, resumesService, snackBar) {
        var _this = _super.call(this) || this;
        _this.httpClient = httpClient;
        _this.dialog = dialog;
        _this.resumesService = resumesService;
    ...
    ResumesComponent.prototype.refresh = function () {
        this.loadData();
    };
    ResumesComponent.prototype.addNew = function () {
        var _this = this;
        var tempDirection;
        ...
        this.subs.sink = dialogRef.afterClosed().subscribe(function (result) {
            ...
            if (result === 1) {
                ...
                (_a = _this.exampleDatabase) === null || _a === void 0 ? void 0 : _a.dataChange.value.unshift(_this.resumesService.getDialogData());
                _this.refreshTable();
                _this.showNotification('snackbar-success', 'Add Record Successfully...!!!', 'bottom', 'center');
            }
        });
    };
    ResumesComponent.prototype.editCall = function (row) {
        var _this = this;
        this.id = row.id;
        var tempDirection;
        if (localStorage.getItem('isRtl') === 'true') {
            ...
            if (result === 1) {
                ...
                if (foundIndex && _this.exampleDatabase) {
                    _this.exampleDatabase.dataChange.value[foundIndex] =
                        _this.resumesService.getDialogData();
    ...
    ResumesComponent.prototype.deleteItem = function (i, row) {
        var _this = this;
        this.index = i;
        this.id = row.id;
        var tempDirection;
    ...
    ResumesComponent.prototype.refreshTable = function () {
        this.paginator._changePageSize(this.paginator.pageSize);
    };
    /** Whether the number of selected elements matches the total number of rows. */
    ResumesComponent.prototype.isAllSelected = function () {
        var _a;
    ...
    ResumesComponent.prototype.masterToggle = function () {
        var _this = this;
        var _a;
        this.isAllSelected()
    ...
    ResumesComponent.prototype.removeSelectedRows = function () {
        var _this = this;
    ...
    ResumesComponent.prototype.loadData = function () {
        var _this = this;
        this.exampleDatabase = new resumes_service_1.ResumesService(this.httpClient);
    ...
    ResumesComponent.prototype.exportExcel = function () {
    ...
    ResumesComponent.prototype.showNotification = function (colorName, text, placementFrom, placementAlign) {
    ...
    // context menu
    ResumesComponent.prototype.onContextMenu = function (event, item) {
    ...
    ], ResumesComponent.prototype, "paginator");
    tslib_1.__decorate([
        core_1.ViewChild(sort_1.MatSort, { static: true })
    ], ResumesComponent.prototype, "sort");
    tslib_1.__decorate([
        core_1.ViewChild('filter', { static: true })
    ], ResumesComponent.prototype, "filter");
    tslib_1.__decorate([
        core_1.ViewChild(menu_1.MatMenuTrigger)
    ], ResumesComponent.prototype, "contextMenu");
    ResumesComponent = tslib_1.__decorate([
        core_1.Component({
    ...
    ExampleDataSource.prototype.connect = function () {
        ...
        return rxjs_1.merge.apply(void 0, tslib_1.__spreadArray([], tslib_1.__read(displayDataChanges))).pipe(operators_1.map(function () {
            ...
            _this.filteredData = _this.exampleDatabase.data
                .slice()
                .filter(function (resumes) {
                var searchStr = (resumes.title +
                    resumes.department +
                    resumes.role +
                    resumes.jobType +
                    resumes.status +
                    resumes.name).toLowerCase();
        ...
        return data.sort(function (a, b) {
            ...
            switch (_this._sort.active) {
                ...
                case 'status':
                    ...
                    break;
                case 'time':
                    _d = tslib_1.__read([a.department, b.department], 2), propertyA = _d[0], propertyB = _d[1];
                    break;
                case 'name':
