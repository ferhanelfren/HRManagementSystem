...
exports.ExampleDataSource = exports.ShortlistComponent = void 0;
var tslib_1 = require("tslib");
var core_1 = require("@angular/core");
var shortlist_service_1 = require("./shortlist.service");
...
var ShortlistComponent = /** @class */ (function (_super) {
    tslib_1.__extends(ShortlistComponent, _super);
    function ShortlistComponent(httpClient, dialog, shortlistService, snackBar) {
        var _this = _super.call(this) || this;
        _this.httpClient = httpClient;
        _this.dialog = dialog;
        _this.shortlistService = shortlistService;
    ...
    ShortlistComponent.prototype.refresh = function () {
        this.loadData();
    };
    ShortlistComponent.prototype.addNew = function () {
        var _this = this;
        var tempDirection;
        ...
        this.subs.sink = dialogRef.afterClosed().subscribe(function (result) {
            ...
            if (result === 1) {
                ...
                (_a = _this.exampleDatabase) === null || _a === void 0 ? void 0 : _a.dataChange.value.unshift(_this.shortlistService.getDialogData());
                _this.refreshTable();
                _this.showNotification('snackbar-success', 'Add Record Successfully...!!!', 'bottom', 'center');
            }
        });
    };
    ShortlistComponent.prototype.editCall = function (row) {
        var _this = this;
        this.id = row.id;
        var tempDirection;
        if (localStorage.getItem('isRtl') === 'true') {
            ...
            if (result === 1) {
                ...
                if (foundIndex && _this.exampleDatabase) {
                    _this.exampleDatabase.dataChange.value[foundIndex] =
                        _this.shortlistService.getDialogData();
    ...
    ShortlistComponent.prototype.deleteItem = function (i, row) {
        var _this = this;
        this.index = i;
        this.id = row.id;
        var tempDirection;
    ...
    ShortlistComponent.prototype.refreshTable = function () {
        this.paginator._changePageSize(this.paginator.pageSize);
    };
    /** Whether the number of selected elements matches the total number of rows. */
    ShortlistComponent.prototype.isAllSelected = function () {
        var numSelected = this.selection.selected.length;
        var numRows = this.dataSource.renderedData.length;
        return numSelected === numRows;
    };
    /** Selects all rows if they are not all selected; otherwise clear selection. */
    ShortlistComponent.prototype.masterToggle = function () {
        var _this = this;
        this.isAllSelected()
    ...
    ShortlistComponent.prototype.removeSelectedRows = function () {
        var _this = this;
    ...
    ShortlistComponent.prototype.loadData = function () {
        var _this = this;
        this.exampleDatabase = new shortlist_service_1.ShortlistService(this.httpClient);
    ...
    ShortlistComponent.prototype.exportExcel = function () {
    ...
    ShortlistComponent.prototype.showNotification = function (colorName, text, placementFrom, placementAlign) {
    ...
    // context menu
    ShortlistComponent.prototype.onContextMenu = function (event, item) {
    ...
    ], ShortlistComponent.prototype, "paginator");
    tslib_1.__decorate([
        core_1.ViewChild(sort_1.MatSort, { static: true })
    ], ShortlistComponent.prototype, "sort");
    tslib_1.__decorate([
        core_1.ViewChild('filter', { static: true })
    ], ShortlistComponent.prototype, "filter");
    tslib_1.__decorate([
        core_1.ViewChild(menu_1.MatMenuTrigger)
    ], ShortlistComponent.prototype, "contextMenu");
    ShortlistComponent = tslib_1.__decorate([
        core_1.Component({
...
exports.ShortlistComponent = ShortlistComponent;
    ...
    ExampleDataSource.prototype.connect = function () {
        ...
        return rxjs_1.merge.apply(void 0, tslib_1.__spreadArray([], tslib_1.__read(displayDataChanges))).pipe(operators_1.map(function () {
            ...
            _this.filteredData = _this.exampleDatabase.data
                .slice()
                .filter(function (shortlist) {
                var searchStr = (shortlist.title +
                    shortlist.email +
                    shortlist.role +
                    shortlist.jobType +
                    shortlist.mobile +
                    shortlist.name).toLowerCase();
...
//# sourceMappingURL=shortlist.component.js.map