...
exports.ExampleDataSource = exports.EmployeeSalaryComponent = void 0;
...
var employee_salary_service_1 = require("./employee-salary.service");
...
var EmployeeSalaryComponent = /** @class */ (function (_super) {
    tslib_1.__extends(EmployeeSalaryComponent, _super);
    function EmployeeSalaryComponent(httpClient, router, dialog, employeeSalaryService, snackBar) {
        var _this = _super.call(this) || this;
        _this.httpClient = httpClient;
        _this.router = router;
        _this.dialog = dialog;
        _this.employeeSalaryService = employeeSalaryService;
    ...
    EmployeeSalaryComponent.prototype.ngOnInit = function () {
        this.loadData();
    };
    EmployeeSalaryComponent.prototype.refresh = function () {
        this.loadData();
    };
    EmployeeSalaryComponent.prototype.addNew = function () {
        var _this = this;
        var tempDirection;
        ...
        this.subs.sink = dialogRef.afterClosed().subscribe(function (result) {
            ...
            if (result === 1) {
                ...
                (_a = _this.exampleDatabase) === null || _a === void 0 ? void 0 : _a.dataChange.value.unshift(_this.employeeSalaryService.getDialogData());
                _this.refreshTable();
                _this.showNotification('snackbar-success', 'Add Record Successfully...!!!', 'bottom', 'center');
            }
        });
    };
    EmployeeSalaryComponent.prototype.editCall = function (row) {
        var _this = this;
        this.id = row.id;
        var tempDirection;
        if (localStorage.getItem('isRtl') === 'true') {
            ...
            if (result === 1) {
                ...
                if (foundIndex && _this.exampleDatabase) {
                    _this.exampleDatabase.dataChange.value[foundIndex] =
                        _this.employeeSalaryService.getDialogData();
    ...
    EmployeeSalaryComponent.prototype.downloadCall = function () {
        this.router.navigateByUrl('admin/payroll/payslip');
    };
    EmployeeSalaryComponent.prototype.deleteItem = function (i, row) {
        var _this = this;
        this.index = i;
        this.id = row.id;
        var tempDirection;
    ...
    EmployeeSalaryComponent.prototype.refreshTable = function () {
        this.paginator._changePageSize(this.paginator.pageSize);
    };
    /** Whether the number of selected elements matches the total number of rows. */
    EmployeeSalaryComponent.prototype.isAllSelected = function () {
        var numSelected = this.selection.selected.length;
        var numRows = this.dataSource.renderedData.length;
        return numSelected === numRows;
    };
    /** Selects all rows if they are not all selected; otherwise clear selection. */
    EmployeeSalaryComponent.prototype.masterToggle = function () {
        var _this = this;
        this.isAllSelected()
    ...
    EmployeeSalaryComponent.prototype.removeSelectedRows = function () {
        var _this = this;
    ...
    EmployeeSalaryComponent.prototype.loadData = function () {
        var _this = this;
        this.exampleDatabase = new employee_salary_service_1.EmployeeSalaryService(this.httpClient);
    ...
    EmployeeSalaryComponent.prototype.exportExcel = function () {
    ...
    EmployeeSalaryComponent.prototype.showNotification = function (colorName, text, placementFrom, placementAlign) {
    ...
    // context menu
    EmployeeSalaryComponent.prototype.onContextMenu = function (event, item) {
    ...
    ], EmployeeSalaryComponent.prototype, "paginator");
    tslib_1.__decorate([
        core_1.ViewChild(sort_1.MatSort, { static: true })
    ], EmployeeSalaryComponent.prototype, "sort");
    tslib_1.__decorate([
        core_1.ViewChild('filter', { static: true })
    ], EmployeeSalaryComponent.prototype, "filter");
    tslib_1.__decorate([
        core_1.ViewChild(menu_1.MatMenuTrigger)
    ], EmployeeSalaryComponent.prototype, "contextMenu");
    EmployeeSalaryComponent = tslib_1.__decorate([
        core_1.Component({
...
exports.EmployeeSalaryComponent = EmployeeSalaryComponent;
    ...
    ExampleDataSource.prototype.connect = function () {
        ...
        return rxjs_1.merge.apply(void 0, tslib_1.__spreadArray([], tslib_1.__read(displayDataChanges))).pipe(operators_1.map(function () {
            ...
            _this.filteredData = _this.exampleDatabase.data
                .slice()
                .filter(function (employeeSalary) {
                var searchStr = (employeeSalary.name +
                    employeeSalary.department +
                    employeeSalary.role +
                    employeeSalary.salary +
                    employeeSalary.email +
                    employeeSalary.empID).toLowerCase();
        ...
        return data.sort(function (a, b) {
            ...
            switch (_this._sort.active) {
                ...
                case 'email':
                    ...
                    break;
                case 'payslip':
                    _d = tslib_1.__read([a.payslip, b.payslip], 2), propertyA = _d[0], propertyB = _d[1];
                    break;
                case 'department':
                    _e = tslib_1.__read([a.department, b.department], 2), propertyA = _e[0], propertyB = _e[1];
                    break;
                case 'empID':
                    _f = tslib_1.__read([a.empID, b.empID], 2), propertyA = _f[0], propertyB = _f[1];
                    break;
            }
...
//# sourceMappingURL=employee-salary.component.js.map