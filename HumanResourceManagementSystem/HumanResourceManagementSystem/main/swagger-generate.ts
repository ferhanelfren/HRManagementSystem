        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<EmployeeEntity>;
                }
            } else
                return _observableThrow(response_) as any as Observable<EmployeeEntity>;
        }));
    }

    protected processGetEmployee(response: HttpResponseBase): Observable<EmployeeEntity> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            result200 = EmployeeEntity.fromJS(resultData200);
...
export class EmployeeEntity implements IEmployeeEntity {
    ...
    email!: string;
    mobile!: string;
    employeeEducationalBackgrounds!: EmployeeEducationalBackgroundEntity[];
    employeeSkills!: EmployeeSkillEntity[];
    employeeWorkExperiences!: EmployeeWorkExperienceEntity[];
    ...
    constructor(data?: IEmployeeEntity) {
        ...
        if (!data) {
            this.employeeEducationalBackgrounds = [];
            this.employeeSkills = [];
            this.employeeWorkExperiences = [];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.positionEntity = _data["positionEntity"] ? PositionEntity.fromJS(_data["positionEntity"]) : new PositionEntity();
            this.departmentEntity = _data["departmentEntity"] ? DepartmentEntity.fromJS(_data["departmentEntity"]) : new DepartmentEntity();
...
export class EmployeeWorkExperienceEntity implements IEmployeeWorkExperienceEntity {
    ...
    workExperienceStarted!: string;
    workExperienceCompleted!: string;
    timestamp!: Date;
